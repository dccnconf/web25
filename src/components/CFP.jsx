...
const CFP = ({topics, className = ""} = {}) => {
  ...
  <div className={className}>
    ...
    <div className="pl-8 mt-8">
      <a href="/downloads/DCCN2025_LaTeX_RU.zip" className="text-indigo-700">
        <FontAwesomeIcon icon={faArchive} size="lg" className="mr-3"/>
        <span className="md:text-lg align-middle">Template in Russian</span>
      </a>
    </div>
    <div className="pl-8 mt-4">
      <a href="/downloads/DCCN2025_LaTeX_EN.zip" className="text-indigo-700">
        <FontAwesomeIcon icon={faArchive} size="lg" className="mr-3"/>
    ...
    <div className="mt-4 pl-8">
      <a href="https://www.overleaf.com/latex/templates/dccn2025-latex-ru/sddtycjtjmbx"
         target="_blank"
    ...
    <div className="mt-4 pl-8">
      <a href="https://www.overleaf.com/latex/templates/dccn2025-latex-eng/pztfxxdfnvcm"
         target="_blank"
         className="text-indigo-700">
        <FontAwesomeIcon icon={faLink} size="lg" className="mr-3"/>
